...
\setCJKfamilyfont{hei}[AutoFakeBold=2.2]{SimHei}
\setCJKfamilyfont{kai}[AutoFakeBold=2.2]{KaiTi}
\ctexset{
    section = {
        name = {第,章},
        format = \zihao{-2}\heiti,
        beforeskip = 1.8ex plus 0.5ex,
        afterskip = 1.1ex plus 0.3ex,
    },
    subsection = {
        format = \zihao{-3}\heiti,
        beforeskip = 1.2ex plus 0.3ex,
...
% --- 页面设置 ---
\usepackage[a4paper, top=2.6cm, bottom=2.4cm, left=2.8cm, right=2.4cm]{geometry}
...
展示 $\operatorname{Mismatch}_g$ 地图。
